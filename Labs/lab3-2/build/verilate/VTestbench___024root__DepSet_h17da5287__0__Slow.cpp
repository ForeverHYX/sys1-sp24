...
#endif
            VL_FATAL_MT("/home/forever/sys1-sp24/src/lab3-2/../../repo/sys-project/lab3-2/sim/testbench.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VTestbench___024root___ctor_var_reset(VTestbench___024root* vlSelf) {
    ...
    vlSelf->Testbench__DOT__cnt_24__DOT____Vcellout__cnt_low__cnt = VL_RAND_RESET_I(4);
    vlSelf->Testbench__DOT__cnt_24__DOT____Vcellout__cnt_high__cnt = VL_RAND_RESET_I(4);
    vlSelf->__Vdly__Testbench__DOT__cnt_24__DOT____Vcellout__cnt_low__cnt = VL_RAND_RESET_I(4);
    vlSelf->__Vdly__Testbench__DOT__cnt_24__DOT____Vcellout__cnt_high__cnt = VL_RAND_RESET_I(4);
