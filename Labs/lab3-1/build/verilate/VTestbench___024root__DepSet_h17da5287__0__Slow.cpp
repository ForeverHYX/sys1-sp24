...
#endif
            VL_FATAL_MT("/home/forever/sys1-sp24/src/lab3-1/../../repo/sys-project/lab3-1/sim/testbench.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VTestbench___024root___ctor_var_reset(VTestbench___024root* vlSelf) {
    ...
    vlSelf->Testbench__DOT__state = VL_RAND_RESET_I(2);
    vlSelf->Testbench__DOT__error = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__fsm__DOT__currentState = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__Testbench__DOT__fsm__DOT__currentState = VL_RAND_RESET_I(2);
