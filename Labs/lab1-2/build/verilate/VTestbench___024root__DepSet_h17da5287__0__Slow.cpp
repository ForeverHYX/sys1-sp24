...
#endif
            VL_FATAL_MT("/home/forever/sys1-sp24/src/lab1-2/../../repo/sys-project/lab1-2/sim/testbench.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VTestbench___024root___ctor_var_reset(VTestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->Testbench__DOT__data = VL_RAND_RESET_I(4);
    vlSelf->Testbench__DOT__point = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__LE = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->Testbench__DOT__dut__DOT__ta = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__tb = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__tc = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__td = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__te = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__tf = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__tg = VL_RAND_RESET_I(1);
    vlSelf->Testbench__DOT__dut__DOT__tp = VL_RAND_RESET_I(1);
